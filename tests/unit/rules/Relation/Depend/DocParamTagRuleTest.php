...
class DocParamTagRuleTest extends RuleTestCase
{
    ...
    private const SUBJECT = 'Fixture\Relation\Depend\DocParamTag\ShouldNotConstraint\Subject';
    private const TARGET = 'Fixture\Relation\Depend\DocParamTag\ShouldNotConstraint\Target';
    ...
    public function testShouldNotConstraint(): void
    {
        $file = $this->createPhpFile(<<<'PHP'
            <?php
            namespace Fixture\Relation\Depend\DocParamTag\ShouldNotConstraint;
            class Target {}
            class Subject
            {
                /** @param Target $p */
