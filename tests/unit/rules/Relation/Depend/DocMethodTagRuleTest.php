...
class DocMethodTagRuleTest extends RuleTestCase
{
    ...
    private const SUBJECT = 'Fixture\Relation\Depend\DocMethodTag\ShouldNotConstraint\Subject';
    private const TARGET = 'Fixture\Relation\Depend\DocMethodTag\ShouldNotConstraint\Target';
    ...
    public function testShouldNotConstraint(): void
    {
        $file = $this->createPhpFile(<<<'PHP'
            <?php
            namespace Fixture\Relation\Depend\DocMethodTag\ShouldNotConstraint;
            class Target {}
