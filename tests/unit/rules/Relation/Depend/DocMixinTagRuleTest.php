...
class DocMixinTagRuleTest extends RuleTestCase
{
    ...
    private const SUBJECT = 'Fixture\Relation\Depend\DocMixinTag\ShouldNotConstraint\Subject';
    private const TARGET = 'Fixture\Relation\Depend\DocMixinTag\ShouldNotConstraint\Target';
    ...
    public function testShouldNotConstraint(): void
    {
        $file = $this->createPhpFile(<<<'PHP'
            <?php
            namespace Fixture\Relation\Depend\DocMixinTag\ShouldNotConstraint;
            class Target {}
            /** @mixin Target */
            class Subject {}
            PHP);
