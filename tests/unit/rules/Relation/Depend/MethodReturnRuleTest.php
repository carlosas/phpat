...
class MethodReturnRuleTest extends RuleTestCase
{
    ...
    {
        $subject = 'Fixture\Relation\Depend\MethodReturn\ShouldNotConstraint\Subject';
        $target = 'Fixture\Relation\Depend\MethodReturn\ShouldNotConstraint\Target';
    ...
    {
        $subject = 'Fixture\Relation\Depend\MethodReturn\CanOnlyConstraint\Subject';
        $target = 'Fixture\Relation\Depend\MethodReturn\CanOnlyConstraint\Allowed';
        $this->configuration = new Configuration(false, true, false);
        $this->testParser = FakeTestParser::create(
            'test',
            Constraint::CanOnly,
        ...
        $this->analyse([$file], [
            [sprintf('%s should not depend on Fixture\Relation\Depend\MethodReturn\CanOnlyConstraint\Target', $subject), 13],
        ]);
    }
