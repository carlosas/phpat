...
- `tests/unit/` — PHPUnit tests for selectors and rules
- `tests/integration/` — Integration tests for PHPat
- `tests/architecture/` — PHPat rules that test PHPat's own architecture (run via PHPStan)
- `tests/fixtures/` — PHP fixture classes used by PHPUnit tests
