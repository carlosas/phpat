...
namespace PHPatOld\Test\Parser;
...
use PHPatOld\Selector\Selector;
use PHPatOld\Test\ArchitectureMarkupTest;
use Psr\EventDispatcher\EventDispatcherInterface;

class XmlTestParser
{
    private TestParser $ruleBuilder;
    private EventDispatcherInterface $eventDispatcher;

    public function __construct(TestParser $ruleBuilder, EventDispatcherInterface $eventDispatcher)
    {
    ...
    private function buildSelector(string $selector, string $selectorRule): Selector
    {
