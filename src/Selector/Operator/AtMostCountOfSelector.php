...
use PhpAT\Parser\Ast\Operator\AtMostCountOf;
use PhpAT\Parser\Ast\ReferenceMap;
use PhpAT\Selector\SelectorInterface;

final class AtMostCountOfSelector implements SelectorInterface
{
    ...
    {
        return 'at most '.$this->threshold.' of '.implode(' or ', array_map(fn (SelectorInterface $selector) => $selector->getParameter(), $this->selectors));
    }
}
